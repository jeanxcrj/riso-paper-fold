...
The **Image** section tunes the upload before it's separated into inks — brightness, contrast, saturation, midtones (gamma) and sharpen — with a reset. The **Flat** deformation mode lays the sheet out with no curl, folds or wrinkle.
